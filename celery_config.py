...
RABBITMQ_PASSWORD = env('RABBITMQ_PASSWORD', default='7820')
RABBITMQ_USER = env('RABBITMQ_USER', default='Kaisar')
RABBITMQ_HOST = env('RABBITMQ_HOST', default='185.121.83.108:30031')
